...
export function HomePage() {
  ...
  return (
    <div className="flex flex-col gap-20 pb-12 pt-8 sm:gap-28 sm:pt-12">
      {/* === HERO === */}
      ...
      {/* === FOOTER : drink responsibly + legal === */}
      <footer className="space-y-4 border-t border-border/60 pt-8 text-xs text-muted-foreground">
        <p className="leading-relaxed">{t('common.moderation')}</p>
        <p className="opacity-70">© {new Date().getFullYear()} {t('app.name')}.</p>
      </footer>
    </div>
  )
}
